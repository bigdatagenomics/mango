var readJsonLocation = "/reads/" + refName + "?start=" + start + "&end=" + end;
var variantJsonLocation = "/variants/" + refName + "?start=" + start + "&end=" + end;
...
function update(newStart, newEnd) {
    ...
    readJsonLocation = ("/reads/" + refName + "?start=" + start + "&end=" + end);
    var numTracks = 0;
